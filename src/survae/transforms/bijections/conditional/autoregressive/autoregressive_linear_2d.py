...
class ConditionalAdditiveAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    ...
    def _elementwise_forward(self, x, elementwise_params):
        return x + elementwise_params, torch.zeros(
...
class ConditionalAffineAutoregressiveBijection2d(ConditionalAutoregressiveBijection2d):
    """
    ...
    def __init__(
        ...
        super(ConditionalAffineAutoregressiveBijection2d, self).__init__(
