...
class ConditionalLinearSplineAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(ConditionalLinearSplineAutoregressiveBijection2d, self).__init__(
...
class ConditionalQuadraticSplineAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(ConditionalQuadraticSplineAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_bins = num_bins
...
class ConditionalCubicSplineAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(ConditionalCubicSplineAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_bins = num_bins
...
class ConditionalRationalQuadraticSplineAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(
            ConditionalRationalQuadraticSplineAutoregressiveBijection2d, self
        ).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
