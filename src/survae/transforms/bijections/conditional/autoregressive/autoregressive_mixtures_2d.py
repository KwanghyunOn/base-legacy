...
from survae.transforms.bijections.functional.mixtures import (
    ...
    censored_logistic_mixture_transform,
)
...
class ConditionalGaussianMixtureAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    def __init__(
        self, autoregressive_net, num_mixtures, autoregressive_order="raster_cwh"
    ):
        super(ConditionalGaussianMixtureAutoregressiveBijection2d, self).__init__(
...
class ConditionalLogisticMixtureAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    def __init__(
        self, autoregressive_net, num_mixtures, autoregressive_order="raster_cwh"
    ):
        super(ConditionalLogisticMixtureAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_mixtures = num_mixtures
...
class ConditionalCensoredLogisticMixtureAutoregressiveBijection2d(
    ConditionalAutoregressiveBijection2d
):
    def __init__(
        self,
        ...
        super(
            ConditionalCensoredLogisticMixtureAutoregressiveBijection2d, self
        ).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
    ...
    def _elementwise(self, inputs, elementwise_params, inverse):
        ...
        x = censored_logistic_mixture_transform(
            inputs=inputs,
            logit_weights=logit_weights,
            means=means,
            log_scales=log_scales,
