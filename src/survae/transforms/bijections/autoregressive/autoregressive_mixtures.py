...
class GaussianMixtureAutoregressiveBijection(AutoregressiveBijection):
    def __init__(self, autoregressive_net, num_mixtures, autoregressive_order="ltr"):
        super(GaussianMixtureAutoregressiveBijection, self).__init__(
...
class LogisticMixtureAutoregressiveBijection(AutoregressiveBijection):
    def __init__(self, autoregressive_net, num_mixtures, autoregressive_order="ltr"):
        super(LogisticMixtureAutoregressiveBijection, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_mixtures = num_mixtures
...
class CensoredLogisticMixtureAutoregressiveBijection(AutoregressiveBijection):
    def __init__(
        self, autoregressive_net, num_mixtures, num_bins, autoregressive_order="ltr"
    ):
        super(CensoredLogisticMixtureAutoregressiveBijection, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_mixtures = num_mixtures
