...
class GaussianMixtureAutoregressiveBijection2d(AutoregressiveBijection2d):
    def __init__(
        ...
        super(GaussianMixtureAutoregressiveBijection2d, self).__init__(
...
class LogisticMixtureAutoregressiveBijection2d(AutoregressiveBijection2d):
    def __init__(
        ...
        super(LogisticMixtureAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_mixtures = num_mixtures
...
class CensoredLogisticMixtureAutoregressiveBijection2d(AutoregressiveBijection2d):
    def __init__(
        ...
        super(CensoredLogisticMixtureAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_mixtures = num_mixtures
