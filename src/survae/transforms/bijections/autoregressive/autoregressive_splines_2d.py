...
class LinearSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(LinearSplineAutoregressiveBijection2d, self).__init__(
...
class QuadraticSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(QuadraticSplineAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_bins = num_bins
    ...
    def _elementwise_forward(self, x, elementwise_params):
        ...
        unnormalized_widths, unnormalized_heights = (
            elementwise_params[..., : self.num_bins],
            elementwise_params[..., self.num_bins :],
        )
...
class CubicSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(CubicSplineAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_bins = num_bins
    ...
    def _elementwise_forward(self, x, elementwise_params):
        ...
        unnorm_derivatives_left = elementwise_params[
            ..., 2 * self.num_bins : 2 * self.num_bins + 1
        ]
...
class RationalQuadraticSplineAutoregressiveBijection2d(AutoregressiveBijection2d):
    def __init__(self, autoregressive_net, num_bins, autoregressive_order="raster_cwh"):
        super(RationalQuadraticSplineAutoregressiveBijection2d, self).__init__(
            autoregressive_net=autoregressive_net,
            autoregressive_order=autoregressive_order,
        )
        self.num_bins = num_bins
