...
class MaskedResidualBlock2d(nn.Module):
    def __init__(self, h, kernel_size=3, data_channels=3):
        ...
        self.conv1 = MaskedConv2d(
            2 * h, h, kernel_size=1, mask_type="B", data_channels=data_channels
        )
        ...
        self.conv3 = MaskedConv2d(
            h, 2 * h, kernel_size=1, mask_type="B", data_channels=data_channels
        )
...
class SpatialMaskedResidualBlock2d(nn.Module):
    def __init__(self, h, kernel_size=3):
        ...
        self.conv2 = SpatialMaskedConv2d(
            h, h, kernel_size=kernel_size, padding=kernel_size // 2, mask_type="B"
        )
